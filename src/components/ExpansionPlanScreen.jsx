            ...
            <div className="expansion-plan__content">
                ...
                <div className="expansion-plan__get-involved">
                    ...
                    <div className="expansion-plan__links">
                        ...
                        <a href="https://github.com/ZK-card/zk-cards" target="_blank" rel="noopener noreferrer" className="expansion-plan__link">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16">
                                <path fill="none" d="M0 0h24v24H0z" />
                        ...
                        <a href="https://x.com/zk_cards" target="_blank" rel="noopener noreferrer" className="expansion-plan__link">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16">
                                <path fill="none" d="M0 0h24v24H0z" />
